...
def get_download_directory(self,loaded_dataset_path,column_one_option_menu, column_two_option_menu):
     ...
     if ( dowload_file_path != ''):
         ...
         downloading_step_button = Button(rightframe, text="Start Downloading", width = 15,command = lambda:start_validation(self,dowload_file_path,loaded_dataset_path,column_one_option_menu.get(), column_two_option_menu.get()) )
